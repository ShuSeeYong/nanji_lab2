...
require '/home8/doubleks/public_html/PHPMailer/src/SMTP.php';
    ...
    $message = "<p>Click the following link to verify your account<br><br><a href='https://doubleksc.com/ShuSeeYong/lab2/php/verify_account.php?email=".$email."&key=".$otp."'>Click Here to Verify Your Account.</a>";
